...
const OfferDetails = ({ setState, pages, loadOfferData,offerId }) => {
  var today = new Date();
  ...
  const { createdOfferError, createdOfferSuccess } = useSelector(
        ...
        <div className="row">
          ...
          <div className="form-group col-md-12">
            ...
            <input
              ...
              placeholder="Points"
              defaultValue={searchObject?.points}
            />
            <span className="invalid-feedback text-danger">
          ...
          <div id="uploadField" className="form-group col-md-12">
            <label>Uploaded Picture</label> <br />
            <img className="mb-2" src={searchObject?.image} alt="" />
            {/* <input
              id="file"
