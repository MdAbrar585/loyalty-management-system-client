...
const UpdateLifeStyle = ({
  ...
  console.log("lifeStyle  ========>>>", searchObject);
          ...
          {!defaultLoader ? (
            ...
            <div className="form-group col-md-12">
              ...
              <select
                ...
                defaultValue={searchObject?.concern_type?.id}
              >
                <option value={searchObject?.concern_type?.id}>
                  {searchObject?.concern_type?.name}
                </option>
                {concernTypeData &&
